  ...
  return (
    <div className="min-h-screen  antialiased p-4 sm:p-8 dark:bg-black">
      <div className="max-w-6xl mx-auto bg-white dark:bg-black rounded-3xl overflow-hidden">
        <div
          className="h-24 sm:h-32 bg-cover bg-center bg-black dark:bg-gray-500"
        ...
        <div className="p-4 -mt-16 sm:-mt-12 text-center">
          ...
          <p className="text-gray-500 text-sm mt-1 mb-3 dark:text-gray-100">{accountDetails?.userName}</p>

          <p className="text-gray-700 dark:text-white max-w-lg mx-auto mb-4 px-2">{accountDetails?.about}</p>
